...
function FloatingShip() {
  ...
  useFrame(({ pointer }, delta) => {
    ...
    ship.rotation.z = MathUtils.lerp(ship.rotation.z, -pointer.x * 0.24, delta * 3);
  ...
  return (
    ...
    >
      ...
      <mesh position={[0.18, 0.28, 0]} scale={[0.58, 0.18, 0.34]}>
        ...
        <meshStandardMaterial color="#111827" metalness={0.2} roughness={0.18} />
      </mesh>

      <mesh position={[-0.62, -0.38, 0.42]} rotation={[0.25, 0, -0.45]}>
        <boxGeometry args={[0.12, 0.78, 0.08]} />
        <meshStandardMaterial color="#60a5fa" metalness={0.38} roughness={0.24} />
      </mesh>
