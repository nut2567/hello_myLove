      ...
      <div className="mx-auto grid w-full max-w-6xl gap-10 lg:grid-cols-[0.8fr_1fr] lg:items-center">
        <div>
          ...
          <p className="mt-5 max-w-xl text-base leading-7 text-muted-foreground">
            หน้านี้ไม่ได้สร้างมาเพื่อการแสดงผลโดยตรง
            แต่จะถูกแสดงขึ้นเมื่อผู้ใช้พยายามเข้าถึงเส้นทางที่ไม่มีอยู่ในระบบ
            หรือเมื่อเกิดข้อผิดพลาดในการโหลดข้อมูลของเส้นทางนั้น ๆ
            ซึ่งอาจเกิดจากการลบเส้นทาง การเปลี่ยนชื่อเส้นทาง
            หรือปัญหาทางเทคนิคอื่น ๆ
            ที่ทำให้ไม่สามารถแสดงเนื้อหาของเส้นทางได้ตามปกติ
          </p>
